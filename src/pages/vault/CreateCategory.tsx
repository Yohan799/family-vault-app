...
const CreateCategory = () => {
  ...
  const handleCreate = () => {
    ...
    toast({
      ...
      description: `${categoryName} has been added to your vault`,
    });
    navigate("/vault");
  };
    ...
    <div className="min-h-screen bg-[#FCFCF9]">
      ...
      <div className="bg-[#FCFCF9] p-6 pt-14 border-b">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-[#1F2121]">New Category</h1>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          <label className="font-semibold text-[#1F2121]">Category Name</label>
          <Input
        ...
        <div className="space-y-3">
          <label className="font-semibold text-[#1F2121]">Choose Icon</label>
        ...
        {/* Choose Color */}
        <div className="space-y-3">
          <label className="font-semibold text-[#1F2121]">Choose Color</label>
          <div className="flex gap-3">
            {colors.map((color) => (
              <button
                key={color.id}
